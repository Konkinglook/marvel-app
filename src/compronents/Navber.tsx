...
export const Navber: FC = ({ children }) => {
            ...
            <nav className='sticky top-0 z-1 bg-red-500'>
                <div className='max-w-7xl mx-auto sm:px-6 lg:px-8'>
                    <div className='flex items-center justify-between h-16'>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className='hidden md:block'>
                                <div className='ml-3 flex items-baseline space-x-2'>
                                    <Link to="/" className="text-white hover:bg-red-800 px-3 py-2 rounded-md test-md font-me">
                                        Home
                                    </Link>
                                    <Link to="/heros" className="text-white hover:bg-red-800 px-3 py-2 rounded-md test-md font-me">
                                        Hero
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div className='flex mr-10 md:hidden'>
                            <p className='text-white font-bold'>Hero</p>
                        </div>
                ...
                {showMenu && (
                    <div className={`flex flex-col px-2 pt-3 pb-3 space-y-1 sm:px-3`}>
                        ...
                        <Link to="/heros" className='text-white hover:bg-red-800 px-3 py-2 rounded-md text-sm font-medium'>
                            Hero
                        </Link>
                    </div>
                )}
